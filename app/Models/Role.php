...
class Role extends Model
{
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopePublic($query, $arg)
    {
        return $query->where('public', $arg)->whereNull('shop_id');
    }
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeNotPublic($query, $arg)
    {
        return $query->where('public', '!=', $arg);
    }
